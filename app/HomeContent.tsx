            ...
            <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-14">
              <div>
                ...
                <div className="mt-7 flex flex-col gap-3 sm:flex-row sm:items-center">
                  <a
                    href="#courses"
                    className="inline-flex items-center justify-center rounded-xl bg-(--brand) px-6 py-3 text-sm font-semibold text-white shadow-sm shadow-[#DDA15E]/25 hover:brightness-110"
                  >
                    Explore Courses
                  </a>
                  <a
              ...
              {featuredCourses.map((course) => (
                ...
                >
                  <div className="relative h-56 overflow-hidden bg-slate-100">
                    ...
                    <span className="absolute bottom-4 left-4 rounded-xl bg-white/90 px-3 py-1.5 text-xs font-bold text-(--brand-2) backdrop-blur-sm">
                      {course.hours}
                    </span>
                  </div>
          ...
          <div className="mx-auto max-w-7xl px-4">
            <div className="flex flex-col items-start justify-between gap-4 sm:flex-row sm:items-end">
              ...
              <a
                ...
                className="inline-flex items-center justify-center rounded-xl bg-(--brand-2) px-4 py-2.5 text-sm font-semibold text-white hover:brightness-110"
              >
                ...
                {reviews.map((review, index) => (
                  ...
                  >
                    <div className="flex items-start justify-between gap-3">
                      <h3 className="text-base font-bold text-(--brand-2)">{review.name}</h3>
                      <span className="rounded-lg bg-(--surface-2) px-2.5 py-1 text-xs font-bold text-(--brand-2)">
          ...
          <div className="mx-auto max-w-7xl px-4">
            <div className="grid gap-8 lg:grid-cols-[1fr_1.05fr] lg:items-start lg:gap-14">
              <div>
                ...
                <h2 className="mt-2 text-2xl font-bold tracking-tight text-(--brand-2) sm:mt-3 sm:text-3xl md:text-4xl">
            ...
            <div className="flex items-start justify-between gap-2 px-4 pb-2 pt-3 sm:gap-3 sm:px-5 sm:pb-3 sm:pt-4">
              <div className="min-w-0">
                ...
                <h2
                  ...
                  className="mt-0.5 truncate text-sm font-extrabold text-(--brand-2) sm:text-base"
                >
              ...
              <button
                type="button"
                onClick={() => setSelectedCourse(null)}
                className="mt-0.5 grid h-7 w-7 shrink-0 place-items-center rounded-full border border-(--border) text-slate-500 transition hover:bg-slate-50 hover:text-(--brand-2) sm:h-8 sm:w-8"
                aria-label="Close"
              >
