...
const pillars = [
  ...
  },
  {
    ...
    number: "02",
    icon: FiTrendingUp,
    color: "from-(--brand-2) to-(--brand-secondary)",
    ringColor: "ring-(--brand-2)/20",
    textAccent: "text-(--brand-2)",
    bgLight: "bg-(--brand-2)/5",
    borderAccent: "border-(--brand-2)/30",
    description:
...
export default function CultureSection() {
  ...
  return (
    <section className="mt-12">
      ...
      {/* Culture Statement */}
      <div className="relative mt-6 overflow-hidden rounded-3xl bg-linear-to-br from-(--brand-2) via-(--brand-secondary) to-(--brand) p-8 text-white shadow-[0_30px_80px_-50px_rgba(221,161,94,0.6)]">
        {/* decorative blobs */}
        ...
        <div className="relative">
          ...
          <p className="mt-3 max-w-2xl text-sm leading-relaxed text-white/80">
            At Edusphere Academy, we foster a culture of continuous learning,
