          ...
          <div className="relative mx-auto max-w-7xl px-4 pb-16 pt-12 sm:pb-20 sm:pt-16 lg:pb-28">
            <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-14">
              <div>
                ...
                Gain practical, job-focused training in caregiving, therapy assistant skills, healthcare administration, childcare, and barista arts. Flexible learning designed to help you start or advance your career in Malaysia and beyond.
                </p>
