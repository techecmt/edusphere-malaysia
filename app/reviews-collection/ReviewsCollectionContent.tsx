    ...
    <div className="min-h-screen bg-white text-slate-900">
      ...
      <main className="mx-auto max-w-3xl px-4 py-12 sm:py-16">
        <div className="rounded-3xl border border-(--border) bg-white p-6 shadow-[0_22px_70px_-60px_rgba(2,6,23,0.65)] sm:p-8">
          ...
          <h1 className="mt-2 text-2xl font-extrabold tracking-tight text-(--brand-2) sm:text-3xl">
            Review Collection Form
          </h1>
          <p className="mt-3 text-sm leading-relaxed text-slate-600">
            Please share your learning experience with Edusphere Academy. Your feedback helps
          ...
          <form className="mt-8 space-y-5" onSubmit={onSubmit}>
            ...
            {averageRating ? (
              <div className="rounded-xl bg-(--surface-2) px-4 py-3 text-sm font-medium text-slate-700">
                ...
                <span className="font-bold text-(--brand-2)">{averageRating} / 5</span>
              </div>
            ) : null}
            ...
            <button
              type="submit"
              disabled={submitting}
              className="inline-flex items-center justify-center rounded-xl bg-(--brand) px-6 py-3 text-sm font-bold text-(--brand-2) shadow-md shadow-[#DDA15E]/25 transition hover:brightness-110 disabled:cursor-not-allowed disabled:opacity-70"
            >
