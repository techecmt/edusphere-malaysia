...
const fees: { label: string; value: string }[] = [
  { label: "Registration Fee (Non-Refundable)", value: "RM100.00" },
  { label: "Course Fee", value: "RM1,100.00" },
];
            ...
            <div className="grid gap-8 lg:grid-cols-[0.9fr_1.1fr] lg:items-center lg:gap-14">
              <div>
                ...
                <p className="mt-4 text-base leading-relaxed text-slate-600">
                  ...
                  three modules — now with a special discount of RM600. The
                ...
                <div>
                  ...
                  <p className="mt-3 text-base leading-relaxed text-slate-600">
                    ...
                    <span className="font-bold text-(--brand-2)">
                      EDUSPHERE ACADEMY OF MANAGEMENT AND TECHNOLOGY SDN. BHD
                    </span>{" "}
