                ...
                {specialisations.map((word, i) => (
                  <Fragment key={word}>
                    ...
                    <motion.span variants={tagWord} className="inline-block">
                      <motion.span
                        className="inline-block bg-linear-to-r from-white via-(--brand) to-white bg-[length:200%_auto] bg-clip-text text-transparent drop-shadow-[0_2px_12px_rgba(221,161,94,0.25)]"
              ...
              {modules.map((mod, i) => (
                ...
                >
                  <div className="grid lg:grid-cols-[0.85fr_1.15fr]">
                    {/* Left rail */}
                    <div className="relative overflow-hidden bg-linear-to-br from-(--brand-2) via-(--brand-secondary) to-[#2A003F] p-6 text-white sm:p-8">
          ...
          <div className="mx-auto max-w-7xl px-4">
            <div className="grid gap-8 lg:grid-cols-[0.9fr_1.1fr] lg:items-center lg:gap-14">
              <div>
                ...
                <a
                  href="#enquire"
                  className="mt-7 inline-flex items-center justify-center rounded-xl bg-(--brand) px-6 py-3 text-sm font-semibold text-white shadow-sm shadow-[#DDA15E]/25 hover:brightness-110"
                >
          ...
          <div className="mx-auto max-w-7xl px-4">
            <div className="mx-auto max-w-3xl text-center">
              ...
              <p className="mt-4 text-base leading-relaxed text-slate-600">
                ...
                must notify Edusphere Academy in writing before the commencement of
            ...
            >
              ...
              <div className="relative grid items-center gap-8 lg:grid-cols-[0.8fr_1.2fr]">
                <div className="flex justify-center">
                  <div className="grid h-28 w-28 place-items-center rounded-4xl bg-(--brand) text-white shadow-xl shadow-[#DDA15E]/30">
